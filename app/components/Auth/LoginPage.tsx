  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-2 sm:p-4">
      <div className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        ...
        <div className="absolute inset-0 bg-linear-to-br from-blue-900/80 via-purple-900/80 to-pink-900/80"></div>
      </div>
      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 max-w-md w-full">
        ...
        {!hasCredentials && (
          <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <button onClick={onSwitchToSetup} className="text-xs sm:text-sm text-blue-600 hover:text-blue-800 font-medium" >
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <button onClick={onSwitchToSignup} className="text-blue-600 hover:text-blue-800 font-medium"
              disabled={!hasCredentials} > Sign up </button>
          </p>
        </div>

        {!hasCredentials && (
          <div className="mt-4 text-center">
            <button onClick={onSwitchToSetup} className="text-sm text-purple-600 hover:text-purple-800 font-medium" >
              🔧 Configure Supabase
            </button>
          </div>
        )}
