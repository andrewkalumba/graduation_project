...
export const SignupPage: React.FC<SignupPageProps> = ({ onSwitchToLogin, onSwitchToSetup }) => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-2 sm:p-4">
      <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/database3.jpg)' }} >
        <div className="absolute inset-0 bg-linear-to-br from-purple-900/80 via-pink-900/80 to-red-900/80"></div>
      </div>
      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 max-w-md w-full max-h-[95vh] overflow-y-auto">
        ...
        {!hasCredentials && (
          <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <button onClick={onSwitchToSetup} className="text-sm text-blue-600 hover:text-blue-800 font-medium" >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
          <div>
            ...
            <input type="text" {...register("fullName")}
              className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base text-gray-900 border rounded-lg focus:outline-none focus:ring-2 transition-colors placeholder:text-gray-400 ${errors.fullName
          ...
          <div>
            ...
            <input type="email" {...register("email")}
              className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base text-gray-900 border rounded-lg focus:outline-none focus:ring-2 transition-colors placeholder:text-gray-400 ${errors.email
                ? "border-red-500 focus:ring-red-500"
                : "border-gray-300 focus:ring-purple-500"
                }`}
          ...
          <div>
            ...
            <input type="password" {...register("password")}
              className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base text-gray-900 border rounded-lg focus:outline-none focus:ring-2 transition-colors placeholder:text-gray-400 ${errors.password
                ? "border-red-500 focus:ring-red-500"
                : "border-gray-300 focus:ring-purple-500"
                }`}
              placeholder="••••••••"
          ...
          <div>
            ...
            <input type="password" {...register("confirmPassword")}
              className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base text-gray-900 border rounded-lg focus:outline-none focus:ring-2 transition-colors placeholder:text-gray-400 ${errors.confirmPassword
                ? "border-red-500 focus:ring-red-500"
                : "border-gray-300 focus:ring-purple-500"
                }`}
              placeholder="••••••••"
          ...
          <button type="submit" disabled={signupMutation.isPending || !hasCredentials}
